...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-group-v vertical', hint_class: :field_with_hint,
  ...
  config.wrappers :horizontal_form, tag: 'div', class: 'form-group-v horizontal grid-x', hint_class: :field_with_hint,
                                    error_class: :error, valid_class: :valid do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    ...
    b.wrapper :label_wrapper, tag: :div, class: 'shrink cell input-label' do |ba|
      ba.use :label, class: 'text-right inline'
    end

    b.wrapper :right_input_wrapper, tag: :div, class: 'auto cell input' do |ba|
      ba.use :input
    end
  ...
  config.wrappers :float_label_wrapper, tag: 'div', class: 'float-label-field', error_class: :error do |b|
    # b.use :html5
    b.optional :readonly

    b.use :input, class: 'float-label-input'
    b.wrapper :label_wrapper, tag: :div, class: 'input-label' do |ba|
      ba.use :label_text
    end
